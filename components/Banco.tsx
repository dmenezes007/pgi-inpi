...
const Banco: React.FC = () => {
    return (
        <div className="module-page">
            ...
            <h2 className="text-xl font-bold text-slate-800 mb-4">O que é o Banco de Ideias?</h2>
            ...
            {/* Destaques */}
            <h2 className="text-xl font-bold text-slate-800 mb-4">Características Essenciais</h2>
